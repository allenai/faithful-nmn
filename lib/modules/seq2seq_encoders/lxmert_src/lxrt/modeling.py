...
class LXRTEncoder(nn.Module):
    ...
    def forward(
        ...
        no_vis_lang_feats = lang_feats

        # Run relational layers
        for layer_module in self.r_layers:
            visn_feats = layer_module(visn_feats, visn_attention_mask)

        no_lang_vis_feats = visn_feats
        ...
        return lang_feats, visn_feats, no_vis_lang_feats, no_lang_vis_feats
...
class LXRTModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        # Run LXRT backbone
        lang_feats, visn_feats, no_vis_lang_feats, no_lang_vis_feats = self.encoder(
            embedding_output,
        ...
        return (
            (lang_feats, visn_feats, no_vis_lang_feats, no_lang_vis_feats),
            pooled_output,
        )
...
class LXRTPretraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        if ans is not None and self.task_qa:
            answer_loss = (
                loss_fct(answer_score.view(-1, self.num_answers), ans.view(-1)) * 2

...
class Counter(nn.Module):
    ...
    def forward(self, boxes, attention):
        ...
        correction_diagonal = correction.view(-1).diag()
        score_matrix = score + correction_diagonal
        degrees = score_matrix.view(self.objects, self.objects).sum(1)
